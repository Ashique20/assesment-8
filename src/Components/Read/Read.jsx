  ...
  return (
    <div className="border-">
      <div className="flex-col ">
        {doneRead.map((read) => (
          <div className="card card-side bg-base-100 shadow-xl p-4 mt-10">
            <figure className="  bg-[#F3F3F3] w-24 p-2">
              <img src={read.image} alt="Movie" />
            </figure>
            <div className="ml-10">
              ...
              <div className="flex gap-4 mt-5">
                ...
                <div className="flex items-center gap-10">
                  <div className="flex">
                    {read.tags.map((tag) => (
                      <p className="text-green-400 font-bold bg-green-50 rounded-xl p-2 ">
                        {tag}
                      </p>
                    ))}
                  </div>
